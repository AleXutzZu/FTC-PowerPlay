...
@Autonomous(name = "FSM Test Right", group = "Debugging")
public class FSMTestRight extends AutonomousControl {
    ...
    protected void initTrajectories() {
        ...
        goToHighJunctionWithPreloadTrajectory = robotHardware.getMecanumDriveController()
                ...
                .splineToSplineHeading(new Pose2d(12, -12, Math.toRadians(45)), Math.toRadians(90))
                .build();
